...
std::shared_ptr<Context> ContextFactory::createTODOContext() { return std::make_shared<TODO>(); }
...
std::shared_ptr<Context> ContextFactory::createWithValueContext(std::any key,
    std::any value,
    std::shared_ptr<Context> parent) {
    return std::make_shared<WithValue>(std::move(key), std::move(value), std::move(parent));
}

std::shared_ptr<Context> ContextFactory::createWithDeadlineContext(time deadline,
    std::shared_ptr<Context> parent) {
